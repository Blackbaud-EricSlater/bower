...
function Project(config, logger) {
    ...
    this._manager = new Manager(this._config, this._logger, this._lockFile);
    this._options = {};
}
...
Project.prototype.install = function (decEndpoints, options, config) {
    ...
    this._config = config || {};
    this._working = true;
    return that._lockFile.preinstall(decEndpoints).then(function() {
        // Analyse the project
...
Project.prototype.update = function (names, options) {
    ...
    return that._analyse()
        .spread(function (json, tree, flattened) {
            return that._lockFile.preupdate(names).then(function() {
